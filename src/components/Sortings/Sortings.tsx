  ...
  return (
    <>
      ...
      <div
        ...
        className="sortings-mobile"
      >
        <div className="sortings-mobile__title">
          <svg
            className="sortings__icon"
            width="24"
            height="24"
      ...
      {openSortings && (
        <div className="sortings-mobile__container">
          <div className="sortings-mobile__list-container">
            <svg
              onClick={() => setOpenSortings(false)}
              className="sortings-mobile__close"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
            ...
            <div className="sortings-mobile__list">
              <div className="sortings-mobile__list-title">
                <svg
                  className="sortings__icon"
                  width="24"
                  height="24"
                ...
                <h4 className="sortings-mobile__list-h">Сортування</h4>
              </div>
              <div className="sortings-mobile__list-items">
                {sortings.map((sorting) => (
                  <SortingMob
                    key={sorting.id}
                    sorting={sorting}
          ...
          <div
            onClick={() => setOpenSortings(false)}
            className="sortings-mobile__backdrop"
          />
        </div>
      )}
    </>
