export const Categories = () => {
  const categories = ['Нумізматика', 'Інтер’єрна спадщина', 'Паперові колеції', 'Інші предмети']
